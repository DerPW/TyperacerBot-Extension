...
chrome.runtime.onMessage.addListener(function (msg, _, sendResponse) {
	console.log('got message ' + msg.delay);
	delay = msg.delay;
	sendResponse({ status: 'Läuft...' });
	...
	var firstWord =
		document.getElementsByClassName('inputPanel')[0].querySelectorAll('span')[0]
			.innerHTML +
		document.getElementsByClassName('inputPanel')[0].querySelectorAll('span')[1]
			.innerHTML;

	var restOfText =
		document.getElementsByClassName('inputPanel')[0].querySelectorAll('span')[2]
			.innerHTML ||
		document.getElementsByClassName('inputPanel')[0].querySelectorAll('span')[1]
			.innerHTML;
